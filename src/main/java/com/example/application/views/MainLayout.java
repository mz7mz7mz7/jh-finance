...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(ListView.class)) {
            nav.addItem(new SideNavItem("List", ListView.class, LineAwesomeIcon.TH_SOLID.create()));
        ...
        if (accessChecker.hasAccess(EmptyView.class)) {
            nav.addItem(new SideNavItem("Empty", EmptyView.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
